...
# helper class and function to make requests using older protocol and avoid SSL errors with Evercore gateways
...
def pull_data(id_list, frequency, api_key):
    ...
    for s_id in id_list:
        ...
        response = get_session().get(base_url, params=api_params(s_id, frequency, api_key), verify = False)
